     ...
     <!-- DIV MUESTRA USUARIO -->
           ...
           <!-- COMIENZO ROW -->
            <div class="row row1">
              ...
              ?>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="border-style: solid;border-color: black;margin-bottom: 20px; margin-right: 10px;"><img alt="imgUsuario" src="../../img/usuarios/default.png" style="max-width: 100%;max-height: 100%;">
                </div>
              <?php }else{
              ?>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="border-style: solid;border-color: black;margin-bottom: 20px; margin-right: 10px;"><img alt="imgUsuario" src="../../img/usuarios/<?php echo $usuario->getImagenPerfil(); ?>" style="max-width: 100%;max-height: 100%;">
                </div>
              <?php
              }
              ?>
              <!--<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" style="border-style: solid;border-color: black;margin-bottom: 20px;"><img alt="imgUsuario" src="../../img/usuarios/<?php echo $usuario->getImagenPerfil();?>" style="max-width: 100%;max-height: 100%;">
              </div>-->
             ...
             <div id="container-formulario">
                ...
                <div id="container-usuarios" style="background:#0275d8; border: solid;border-radius:5px; border-color: black;">
                   <form action="../../controller/defaultController.php?controlador=usuario&accion=modificarPerfil" method="post" style="margin:10px;" enctype="multipart/form-data">
                   <!-- COMIENZO ROW-->
