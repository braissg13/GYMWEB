...
if(!isset($_SESSION)) session_start();
 ...
 if ($_SESSION['tipoUsuario'] =='Entrenador'){
  ...
  $row2 = UsuarioController::getAllDeportistasTDU();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <div class="container">
    ...
    <div class="row" style="margin-top: 20px; margin-bottom: 10px;">
      ...
      <div id="container-formulario" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
        <form action="../../controller/defaultController.php?controlador=tabla&accion=asignarDeportistaTDU" method="POST" style="margin:10px;">
          <!-- DIV TIPO EJER -->
      ...
      <!-- DIV FORMULARIO 2 -->
      <div id="container-formulario" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
        <form action="../../controller/defaultController.php?controlador=tabla&accion=deleteAsignarDeportistaTDU" method="POST" style="margin:10px;">
          <!-- DIV TIPO EJER -->
