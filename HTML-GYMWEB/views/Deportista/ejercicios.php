...
if(!isset($_SESSION)) session_start();
 ...
 /*Aqui comprobamos que no intenten entrar otros Usuarios que no sean Deportistas*/
		 ...
		 <div class="row" style="margin-top: 20px; margin-bottom: 10px;">
    		...
    		<ul class="dropdown-menu">
    			<li class="dropdown-header">Mostrar Ejercicios de:</li>
      			<li><a href="ejercicios.php">Todos</a></li>
            <li><a href="ejerciciosFiltrado.php?filtrado=Brazos">Brazos</a></li>
            <li><a href="ejerciciosFiltrado.php?filtrado=Espalda">Espalda</a></li>
            <li><a href="ejerciciosFiltrado.php?filtrado=Pecho">Pecho</a></li>
            <li><a href="ejerciciosFiltrado.php?filtrado=Piernas">Piernas</a></li>
    		</ul>
  		 </div>
  	 </div>
